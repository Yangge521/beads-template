...
export const CATEGORIES: Category[] = [
  ...
  { id: 'nature', name: '自然风景', icon: 'Mountain', description: '山川、海景、星空等自然风光', sortOrder: 14 },
  { id: 'portrait', name: '人物肖像', icon: 'User', description: '名画、艺术人物像素化', sortOrder: 15 },
  { id: 'abstract', name: '抽象艺术', icon: 'Shapes', description: '几何、渐变、波普等现代艺术', sortOrder: 16 },
  { id: 'logo', name: '品牌 Logo', icon: 'Tag', description: '经典品牌 Logo 致敬简化版', sortOrder: 17 },
